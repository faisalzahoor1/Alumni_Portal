...
from app.alumni.services.notification_service import NotificationService

router = APIRouter(prefix="/notifications", tags=["Alumni Notifications"])
...
async def get_unread_count(current_user: User = Depends(get_current_alumni_user)):
