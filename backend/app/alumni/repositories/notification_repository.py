...
from app.alumni.models.notification import AlumniNotification


class NotificationRepository:

    @staticmethod
    async def create_notification(notification: AlumniNotification) -> AlumniNotification:
    ...
    @staticmethod
    async def get_by_id(notification_id: str) -> Optional[AlumniNotification]:
        ...
        return AlumniNotification(**document)
    ...
    async def get_all_for_recipient(
        ...
        async for document in cursor:
            document["id"] = str(document.pop("_id"))
            notifications.append(AlumniNotification(**document))
    ...
    @staticmethod
    async def mark_as_read(notification_id: str, recipient_id: str) -> Optional[AlumniNotification]:
        if not ObjectId.is_valid(notification_id):
            return None
